...
import static com.lanjiang.figersland.R.id.iv_choice_of_suppliers;

/**
 * Created by Lin on 2016/12/13.
 */

public class MyReleaseTenderDetailActivity extends BaseToolbarActivity {
    ...
    @BindView(R.id.tv_choice_of_suppliers)
    TextView tvChoiceOfSuppliers;
    @BindView(R.id.tv_choice_of_suppliers_content)
    TextView tvChoiceOfSuppliersContent;
    @BindView(iv_choice_of_suppliers)
    ImageView ivChoiceOfSuppliers;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_my_release_tender_detail);
        super.unbinder = ButterKnife.bind(this);
    }

    @Override
    public void setActionBar() {
        setActivityTitle(getString(R.string.the_tender_details));
    }

    @OnClick({R.id.tv_edit, R.id.iv_click_contact_details, R.id.iv_click_sign_up_details,
            R.id.iv_click_tender_details, R.id.btn_sure, R.id.iv_check, R.id.iv_click_details,
            R.id.iv_check2, R.id.iv_click_details2, R.id.tv_file_download, R.id.rl_company1,
            R.id.rl_company2, R.id.iv_choice_of_suppliers})
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.iv_click_tender_details:
                ...
                break;
            case R.id.iv_choice_of_suppliers:
                startActivity(new Intent(mContext, ChoiceOfSupplierActivity.class));
                break;
            case R.id.btn_sure:
                ...
                btnSure.setBackgroundResource(R.drawable.shape_btn_blue);
                btnSure.setTextColor(getResources().getColor(R.color.color_main));
                break;
            case R.id.iv_check:
