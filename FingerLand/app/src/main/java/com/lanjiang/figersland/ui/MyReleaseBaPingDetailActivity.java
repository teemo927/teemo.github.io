...
public class MyReleaseBaPingDetailActivity extends BaseToolbarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_my_release_baping_detail);
        super.unbinder = ButterKnife.bind(this);
    }

    @Override
    public void setActionBar() {
        setActivityTitle(getString(R.string.baping_order_details));
    }

    @OnClick({R.id.tv_edit, R.id.iv_status1, R.id.iv_status2, R.id.iv_status3, R.id.iv_status4, R.id.iv_status5})
